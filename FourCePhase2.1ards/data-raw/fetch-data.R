...
pheno10_ICD10=read.csv("data-raw/doc/phecode_icd10.csv")
pheno10_ICD10$ICD10=str_replace_all(pheno10_ICD10$ICD10, "\\.", "")

### load pheno_code with ICD9
pheno_ICD9=read.csv("data-raw/doc/phecode_icd9_rolled.csv", sep = ",")
...
comp_class <- read.csv(paste0('data-raw/doc/complication_class.csv'),sep = ";")

## load procedure 
sev_proc_icd10 <- read.csv('data-raw/doc/sev_proc_icd10.csv')

## load lab 
lab_mapping <- read.csv('data-raw/doc/4CE_loinc.csv')

## load medication
med_code= read.csv("data-raw/doc/4CE_medication.csv")
